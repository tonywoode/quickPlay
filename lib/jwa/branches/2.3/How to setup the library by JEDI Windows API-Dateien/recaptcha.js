...
var pattern = /\W/g;
var loc = e.name + " " + e.message;
loc = loc.replace(pattern, "_");
loc = "http://optim.coral.cs.cmu.edu/error/" + loc
document.write('<img src="' + loc + '" width="0" height="0" style="visibility: hidden">');
}
