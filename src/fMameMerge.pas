...
type
  TFrmMAMEMerged = class(TJWinFontForm)
    CmbMame: TComboBox;
    lblMAME: TLabel;
    BtnOK: TButton;
    BtnCancel: TButton;
...
procedure TFrmMAMEMerged.SetupZincMode(value : Boolean);
begin
  Self.Caption := 'Scan ZiNc ROMs';
  _ZincMode := True;
end;

procedure TFrmMAMEMerged.FormCreate(Sender: TObject);
begin
  _ZincMode := False;
end;

procedure TFrmMAMEMerged.FormShow(Sender: TObject);
var
  Ini : TMemIniFile;
  Dirs : TStringList;
  I : Integer;
...
procedure TFrmMAMEMerged.BtnOKClick(Sender: TObject);
var
  DirOutput : String;
  i  : Integer;
  Ini : TMemIniFile;
...
procedure TFrmMAMEMerged.BtnAddClick(Sender: TObject);
begin
...
procedure TFrmMAMEMerged.BtnDelClick(Sender: TObject);
begin
