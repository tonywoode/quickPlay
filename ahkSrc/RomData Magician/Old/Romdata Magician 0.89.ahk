...
; Name|Ini Name|ParentName|ZipName|path|Emulator|Company|Year|Game Type|Rating|Language|Parameters|Comment|NumPlayed|ParamMode|<IPS>|IPS1|IPS2|IPS3|</IPS>|Players|DefaultGoodMerge|System
 ...
 ColWidth =   350,0,0,0,0,0,200,70,90,70,70,0,150,50,0,0,0,0,0,0,100,0,0,280,170
 Loop, Parse, ColWidth, `,
 ...
 Gui, Add, DropDownList, x270 yp-3 w126 AltSubmit vSelectedRating, %DD_ratings%
 ...
 Gui, Add, DropDownList, x270 yp-3 w126 AltSubmit vSelectedComment, Control Type||Perspective|Other Systems|ESRB
 ...
 Gui, Add, DropDownList, x270 yp-3 w126 AltSubmit vSelectedCompany, Company / Publisher||Company|Publisher
