...
; Name|Ini Name|ParentName|ZipName|path|Emulator|Company|Year|Game Type|Rating|Language|Parameters|Comment|NumPlayed|ParamMode|<IPS>|IPS1|IPS2|IPS3|</IPS>|Players|DefaultGoodMerge|System
 ...
 Gui, Font, Bold
 Gui, Add, GroupBox, x2 y+10 w400 h305 Section, RomData Options
 Gui, Font, Norm
 ...
 Gui, Add, DropDownList, x270 yp-3 w116 AltSubmit vSelectedRating, %DD_ratings%
 ...
 Gui, Add, DropDownList, x270 yp-3 w116 AltSubmit vSelectedComment, Control Type||Perspective|Other Systems|ESRB
 ...
 Gui, Add, DropDownList, x270 yp-3 w116 AltSubmit vSelectedCompany, Company/Publisher||Company|Publisher
 ...
 Gui, Add, StatusBar, x30 w324
  ...
  ;Language
 Gui, Font, Bold
 Gui, Add, GroupBox, Section xs+420 ys w390 h305, Language
 Gui, Font, Norm
