...
type
  TFrmMamePrintMFMSet = class(TJWinFontForm)
    CmbMame: TComboBox;
    lblMAME: TLabel;
    BtnOK: TButton;
    BtnCancel: TButton;
...
procedure TFrmMamePrintMFMSet.FormShow(Sender: TObject);
var
  Ini : TMemIniFile;
  Dirs : TStringList;
  I : Integer;
...
procedure TFrmMamePrintMFMSet.BtnMameExtrasDirFindClick(Sender: TObject);
var
  jvBrowse: TJvBrowseForFolderDialog;
begin
...
procedure TFrmMamePrintMFMSet.BtnOKClick(Sender: TObject);
var
  DirOutput : String;
  i  : Integer;
  Ini : TMemIniFile;
...
procedure TFrmMamePrintMFMSet.CmbMameChange(Sender: TObject);
begin
...
procedure TFrmMamePrintMFMSet.BtnAddClick(Sender: TObject);
begin
...
procedure TFrmMamePrintMFMSet.BtnDelClick(Sender: TObject);
begin
