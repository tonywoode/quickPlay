...
CreateGUIs()
{
 ...
 Gui, Font, Norm
 Gui, Add, ListView, xp+20 yp+25 w354 r14 AltSubmit gLanguageLV vLanguageLV, Code|Language
 LV_ModifyCol(1, 175)
 LV_ModifyCol(2, 175)
 ...
 Gui, Add, Button, xp y+14 w85 gAddSRL, Add New
 Gui, Add, Button, xp y+14 w85 gReplaceSRL, Replace   
 Gui, Add, Button, xp y+14 w85 gRemoveSRL, Delete
 Gui, Add, Button, xp y+14 w85 gClearSRL, Delete All
 Gui, Add, Button, xp y+14 w38 gMoveUp, /\
 Gui, Add, Button, x+10 yp w38 gMoveDown, \/
 Gosub, LoadSRL 
 Gui, Show, Maximize, %ScriptName%
}

;******************************* String Replacement Gui Labels/Subs ********************************
