...
;   MsgBox, %Emulator% - %System%
 ...
 Loop, Parse, OptionsToSimplify, |
 {
  ...
  FileRead, ListContents, Key Lists\%A_LoopField%.txt
  Loop, Parse, ListContents, `r, `n%A_Space%
  {
...
; Name|Ini Name|ParentName|ZipName|path|Emulator|Company|Year|Game Type|Rating|Language|Parameters|Comment|NumPlayed|ParamMode|<IPS>|IPS1|IPS2|IPS3|</IPS>|Players|DefaultGoodMerge|System
 ...
 ColWidth =   300,200,0,0,0,200,150,70,90,70,70,0,150,50,0,0,0,0,0,0,100,0,50
 Loop, Parse, ColWidth, `,
 ...
 Gui, Add, CheckBox, x270 yp-15 vSimplifyData, Simplify Data
 Gui, Add, CheckBox, x30 yp+40 vAddRating, Add Rating
...
;  SystemCol := PlayersCol+2 ;Previously used this for Col Below. Not sure why? 
  ...
  If AddComment = 1
  {
   ...
   If (TempVar = "") OR (WriteComment = 1)
   {
    ...
    NewComment = %System%_%Section%_%CommentType%  ;%CurrentPrefix%%_VarPrefixDelim%%CurrentVarName% = %CurrentVarContent%
...
LoadRomData:
 ...
 RowNumber =
 ROMDataFileVersion =
 StringReplace, RomDataDat, RomDataDat,`r, `r, UseErrorLevel
 GuiControl, Count%ErrorLevel%, QuickPlayLV
