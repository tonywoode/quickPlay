...
enum TVirtualNodeState { vsInitialized, vsChecking, vsCutOrCopy, vsDisabled, vsDeleting, vsExpanded, vsHasChildren, vsVisible, vsSelected, vsInitialUserData, vsAllChildrenHidden, vsClearing, vsMultiline, vsHeightMeasured, vsToggling, vsHidden };
#pragma option pop

typedef Set<TVirtualNodeState, vsInitialized, vsHidden>  TVirtualNodeStates;
...
typedef Set<TVTPaintOption, toHideFocusRect, toShowHiddenNodes>  TVTPaintOptions;
...
public:
	...
	int __fastcall ResizeColumns(int ChangeBy, TColumnIndex RangeStartCol, TColumnIndex RangeEndCol, TVTColumnOptions Options = (Set<TVTColumnOption, coAllowClick, coUseCaptionAlignment> () << TVTColumnOption(7) ));
...
private:
	...
	bool __fastcall GetHidden(PVirtualNode Node);
	...
	void __fastcall SetHidden(PVirtualNode Node, bool Value);
	void __fastcall SetImages(const Imglist::TCustomImageList* Value);
...
protected:
	...
	virtual void __fastcall DoStateChange(const TVirtualTreeStates &Enter, const TVirtualTreeStates &Leave = Set<VirtualTrees__71, tsCancelHintAnimation, tsWindowCreating> () );
...
public:
	...
	PVirtualNode __fastcall GetFirstVisible(PVirtualNode Node = (void *)(0x0), bool ConsiderChildrenAbove = true, bool IncludeHidden = false);
	PVirtualNode __fastcall GetFirstVisibleChild(PVirtualNode Node, bool IncludeHidden = false);
	PVirtualNode __fastcall GetFirstVisibleChildNoInit(PVirtualNode Node, bool IncludeHidden = false);
	PVirtualNode __fastcall GetFirstVisibleNoInit(PVirtualNode Node = (void *)(0x0), bool ConsiderChildrenAbove = true, bool IncludeHidden = false);
	...
	PVirtualNode __fastcall GetLastVisible(PVirtualNode Node = (void *)(0x0), bool ConsiderChildrenAbove = true, bool IncludeHidden = false);
	PVirtualNode __fastcall GetLastVisibleChild(PVirtualNode Node, bool IncludeHidden = false);
	PVirtualNode __fastcall GetLastVisibleChildNoInit(PVirtualNode Node, bool IncludeHidden = false);
	PVirtualNode __fastcall GetLastVisibleNoInit(PVirtualNode Node = (void *)(0x0), bool ConsiderChildrenAbove = true, bool IncludeHidden = false);
	...
	PVirtualNode __fastcall GetNextVisibleSibling(PVirtualNode Node, bool IncludeHidden = false);
	PVirtualNode __fastcall GetNextVisibleSiblingNoInit(PVirtualNode Node, bool IncludeHidden = false);
	...
	PVirtualNode __fastcall GetPreviousVisibleSibling(PVirtualNode Node, bool IncludeHidden = false);
	PVirtualNode __fastcall GetPreviousVisibleSiblingNoInit(PVirtualNode Node, bool IncludeHidden = false);
	...
	PVirtualNode __fastcall GetVisibleParent(PVirtualNode Node, bool IncludeHidden = false);
	...
	bool __fastcall IsEffectivelyHidden(PVirtualNode Node);
	bool __fastcall IsEffectivelyVisible(PVirtualNode Node);
	bool __fastcall IsMouseSelecting(void);
	PVirtualNode __fastcall IterateSubtree(PVirtualNode Node, TVTGetNodeProc Callback, void * Data, TVirtualNodeStates Filter = Set<TVirtualNodeState, vsInitialized, vsHidden> () , bool DoInit = false, bool ChildNodesOnly = false);
	...
	__property bool IsHidden[PVirtualNode Node] = {read=GetHidden, write=SetHidden};
...
public:
	...
	WideString __fastcall ContentToUnicode(TVSTTextSourceType Source, WideChar Separator)/* overload */;
...
#define DefaultPaintOptions (Set<TVTPaintOption, toHideFocusRect, toShowHiddenNodes> () << TVTPaintOption(5) << TVTPaintOption(6) << TVTPaintOption(8) << TVTPaintOption(9) << TVTPaintOption(11) << TVTPaintOption(12) )
...
#define DefaultMiscOptions (Set<TVTMiscOption, toAcceptOLEDrop, toEditOnDblClick> () << TVTMiscOption(0) << TVTMiscOption(3) << TVTMiscOption(5) << TVTMiscOption(7) << TVTMiscOption(8) << TVTMiscOption(14) )
#define DefaultColumnOptions (Set<TVTColumnOption, coAllowClick, coUseCaptionAlignment> () << TVTColumnOption(0) << TVTColumnOption(1) << TVTColumnOption(2) << TVTColumnOption(3) << TVTColumnOption(4) << TVTColumnOption(5) << TVTColumnOption(6) << TVTColumnOption(7) << TVTColumnOption(11) )
