...
InitializeVars()
{
 ...
 If SystemIniFilePath = Error
 {
  ...
  IniWrite, %SystemIniFilePath%, %ScriptIni%, General, SystemIniFilePath, Error
 }
 Glob(IniPaths, SystemIniFilePath . "\*\*.ini", 0,0)
...
; GuiControl, -Redraw, QuickPlayLV
 ...
 ; MsgBox, %RowNumber%`,%SystemCol%
  LV_GetText(Emulator, RowNumber, 6) ;   From Above: %Emulator% := System
  System := %Emulator%
;  MsgBox, %System% - %Emulator%
